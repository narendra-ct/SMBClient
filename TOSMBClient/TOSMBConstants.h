...
/** SMB File Download Connection State */
typedef NS_ENUM(NSInteger, TOSMBSessionUploadTaskState) {
    TOSMBSessionUploadTaskStateReady,
    TOSMBSessionUploadTaskStateRunning,
    TOSMBSessionUploadTaskStateSuspended,
    TOSMBSessionUploadTaskStateCancelled,
    TOSMBSessionUploadTaskStateCompleted
};
